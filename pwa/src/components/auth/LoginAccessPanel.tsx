  ...
  return (
    <aside className="space-y-4 rounded-lg border border-zinc-200 bg-white p-6">
      ...
      <div className="border-t border-zinc-200 pt-4">
        ...
        <a
          href={otherApp.href}
          className="mt-2 inline-block text-sm font-medium text-zinc-900 underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-zinc-400"
        >
          {otherApp.label} →
        </a>
      </div>
